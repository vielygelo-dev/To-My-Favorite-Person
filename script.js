/* ==========================================================================
   ...
   NOTE: several functions below (gallery lightbox, timeline reveal,
   reason cards) guard themselves with an early `return` if their section
   isn't present in index.html. This page currently only has Story /
   Letter / Surprise sections — without these guards, a missing element
   throws an error that stops every init function queued after it
   (including the background music), which was the original bug.
   ========================================================================== */
...
function initGalleryLightbox() {
  ...
  if (!lightbox) return; // no gallery section on this page — nothing to wire up
...
function initReasonCards() {
  ...
  if (!cards.length) return; // no reasons section on this page — nothing to wire up
...
function initBackgroundMusic() {
  ...
  if (!audio || !toggleBtn || !iconOn || !iconOff) return;
